...
@section('module-description', 'Applications, assessment activity, and scheduled interviews for the selected month.')
@section('content')
...
<div class="rpt-header">
    ...
    <div class="rpt-user-info">
        ...
        <div class="rpt-user-meta">
            ...
            @endif
            <span><i class="bi bi-people"></i> {{ $ownedCandidatesCount ?? 0 }} candidates</span>
        </div>
    </div>
    {{-- Month selector --}}
...
<div class="rpt-stats">
    ...
    <div class="rpt-stat">
        ...
        <div class="rpt-stat-body">
            <div class="rpt-stat-val" style="color:var(--purple-text);">{{ $totals['assessment'] }}</div>
            <div class="rpt-stat-lbl">Assessment</div>
        </div>
    </div>
    <div class="rpt-stat">
...
<div class="rpt-tabs">
    <button type="button" class="rpt-tab active" id="tabBtnApps" onclick="switchRptTab('apps')">
        <i class="bi bi-bar-chart-fill"></i> Applications &amp; Assessment
    </button>
                ...
                <table class="rpt-tbl">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center;">
                                <span style="color:var(--purple-text);">●</span> Assessment
                            </th>
                            <th style="text-align:center;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;">
                                @if ($row['assessment'] > 0)
                                    <span class="badge" style="background:var(--purple-light);color:var(--purple-text);min-width:32px;">{{ $row['assessment'] }}</span>
                                @else
                                    <span style="color:var(--text-muted);font-size:12px;">—</span>
                                @endif
                            </td>
                    ...
                    <tfoot>
                        <tr style="background:var(--main-bg);border-top:2px solid var(--border-color);">
                            ...
                            <td style="text-align:center;"><span class="badge" style="background:var(--purple-light);color:var(--purple-text);min-width:32px;font-weight:700;">{{ $totals['assessment'] }}</span></td>
