 ...
 *   - Daily logs spread across the current month (with real applications / assessment values)
...
class ReportTestSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $logDays = [
            // [day, apps, assessment, remark]
            [1,  5,  3, 'Sent batch applications on day 1.'],
            [2,  8,  5, 'Used AI assessment heavily today.'],
            [3,  4,  2, 'Slower day.'],
        ...
        $this->command->info("     Assessment   : {$totalAsst}");
